...
field_id_common_label = np.intersect1d(np.intersect1d(field_id_0608[:,2], field_id_0812[:,2]), \
                                np.intersect1d(field_id_1214[:,2], field_id_1516[:,2]))
...
for id in field_id_common_label:
    if id in meteorological_id:
        ...
        print id
    assert field_id_0608_dict[id] == field_id_0812_dict[id] and \
